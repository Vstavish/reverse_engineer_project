...
leaflet() %>%
  ...
  addPolygons(data=geo_public_transportation, 
              ...
              smoothFactor = 0.2,
              fillOpacity = 0.5,
              label = paste("Public Transportation Percent is:",(scales::number(geo_public_transportation$public_transportation_pct)), "for",geo_public_transportation$community)) %>% 
  addLegend(
