...
leaflet() %>%
  ...
  addPolygons(data=geo_public_transportation, 
              ...
              smoothFactor = 0.2,
              fillOpacity = 0.5,
              label = paste("Percent of that uses public transportation is:",(scales::number(geo_public_transportation$public_transportation_pct)), "for",geo_public_transportation$community)) %>% 
  addLegend(
    position = "bottomright",
    pal = pal,
    values = geo_public_transportation$public_transportation_pct,
    title = "Public Transportation Percentage<br>Per Neighborhood in 2020"
  )
```
