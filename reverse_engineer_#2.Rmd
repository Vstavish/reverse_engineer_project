...
# Our project looks at homicide arrests in 50 of this nation's largest cities across the past decade.
...
#Yes, all of these rates are below 30 percent.
...
#And while most cities saw their arrest rates drop gradually, Baltimore’s decline was sudden — plummeting 15 percentage points in 2015
#By Parker
```{r}
...
#note for victoria. i am trying to calculate the difference from 2015 to 2014, but i can't figure out how to do it properly because of the weird way the data data is formatted.
```
#Major police departments that have success in making arrests generally assign detectives fewer than five cases a year
#By Parker
```{r}
num_cases <- homicide_data %>% 
  ...
  count(reported_date)
#note for victoria. i am trying to calculate the counts per year, but again i can't figure out how to do it properly because of the weird way the date data is formatted.
```
